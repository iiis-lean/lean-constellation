...
def build_tool_specs() -> list[ToolSpec]:
    ...
    return [
        handler_tool(
            ...
            groups={"node_contract_read_current"},
            roles=all_roles,
        ...
        direct_tool(
            ...
            result_view="current_node_contract",
            groups={"node_contract_read_coordinator"},
            roles=all_roles,
        ),
        direct_tool(
            name="get_node_tree",
            ...
            groups={"node_tree_coordinator_read"},
            roles=all_roles,
        ),
        handler_tool(
            name="get_node",
        ...
        direct_tool(
            ...
            groups={"content_task_admission_read"},
        ...
        direct_tool(
            ...
            result_view="node",
            groups={"node_tree_coordinator_write"},
            roles=coordinator_roles,
        ),
        direct_tool(
        ...
        direct_tool(
            ...
            groups={"node_contract_core_coordinator_write"},
            roles=coordinator_roles,
        ),
        handler_tool(
        ...
        handler_tool(
            ...
            groups={"node_boundary_read_current"},
            roles=all_roles,
        ...
        handler_tool(
            ...
            capability=ToolCapability.WRITE,
            result_view="current_node_contract",
            groups={"node_contract_dependency_current_write"},
            roles=write_roles,
        ...
        handler_tool(
            ...
            capability=ToolCapability.WRITE,
            result_view="current_node_contract",
            groups={"node_contract_material_current_write"},
            roles=write_roles,
        ...
        direct_tool(
            ...
            groups={"scope_export_interface_read"},
            roles=all_roles,
        ),
        handler_tool(
            ...
            capability=ToolCapability.WRITE,
            result_view="node_contract",
            groups={"scope_export_interface_write"},
            roles=coordinator_roles,
