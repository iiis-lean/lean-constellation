...
def build_tool_specs() -> list[ToolSpec]:
    ...
    return [
        handler_tool(
            ...
            groups={AppGroup.STATEMENT_FORMAL_DIAGNOSTICS_READ, AppGroup.PROOF_FORMAL_DIAGNOSTICS_READ},
            roles=roles,
        ...
        handler_tool(
            ...
            groups={AppGroup.STATEMENT_FORMAL_DIAGNOSTICS_READ},
            roles=roles,
        ...
        handler_tool(
            ...
            capability=ToolCapability.READ,
            result_view="lean_check",
            groups={AppGroup.PROOF_FORMAL_DIAGNOSTICS_READ},
            roles=roles,
