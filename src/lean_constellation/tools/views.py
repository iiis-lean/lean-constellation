...
def build_application_tool_views(group_specs: Iterable[ToolGroupSpec] | None = None) -> list[ToolViewSpec]:
    """Build production application views from orthogonal capability groups."""
    ...
    return [
        ...
        _view(
            ...
            [
                ...
                AppGroup.SOURCE_INDEX_FULL_AUDIT_READ,
                AppGroup.SOURCE_INDEX_DRAFT_CONTEXT_READ,
                AppGroup.SOURCE_INDEX_DRAFT_WRITE,
            ],
        ...
        _view(
            ...
            [
                ...
                AppGroup.ROOT_INTERFACE_APPEND_WRITE,
            ],
        ...
        _view(
            ...
            [
                ...
                AppGroup.ADAPTER_IMPORT_PREVIEW_READ,
                AppGroup.ADAPTER_CATALOG_READY_READ,
            ],
        ...
        _view(
            AppView.REPO_RESOURCE_DISCOVERY,
            [
                AppGroup.REPO_PREPARATION_INPUT_READ,
        ...
        _view(
            AppView.REPO_LEAN_PROVIDER_DISCOVERY,
            [
                AppGroup.REPO_PREPARATION_INPUT_READ,
                AppGroup.REPO_COMPLETION_POLICY_READ,
                AppGroup.SOURCE_CORPUS_READ,
