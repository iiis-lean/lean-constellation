...
def build_application_tool_views(group_specs: Iterable[ToolGroupSpec] | None = None) -> list[ToolViewSpec]:
    ...
    return [
        _view(
            ...
            [AppGroup.REPO_PREPARATION_INPUT_READ, AppGroup.WORKSPACE_REPO_CATALOG_READ, AppGroup.UPSTREAM_REPO_SEARCH],
        ...
        _view(
            ...
            [
                ...
                AppGroup.UPSTREAM_METADATA_WRITE,
                ...
                AppGroup.ADAPTER_PROJECTION_WRITE,
        ...
        _view(
            ...
            [AppGroup.RESOURCE_CURATION_CONTEXT_READ, AppGroup.MATERIAL_ACQUISITION, AppGroup.RESOURCE_LIBRARY_READ, AppGroup.RESOURCE_DRAFT_WRITE],
        ...
        _view(
            ...
            [
                ...
                AppGroup.WORKSPACE_REQUIREMENT_WRITE,
                ...
                AppGroup.EXTERNAL_THEOREM_SEARCH,
            ],
        ...
        _view(
            ...
            [
                ...
                AppGroup.SOURCE_MATERIAL_TEXT_READ,
                AppGroup.RESOURCE_LIBRARY_READ,
                AppGroup.RESOURCE_CURATION_CONTEXT_READ,
                AppGroup.MATHLIB_INDEX_READ,
                AppGroup.MATHLIB_INDEX_WRITE,
                AppGroup.MATHLIB_SEMANTIC_SEARCH,
                AppGroup.MATHLIB_NAVIGATION,
                ...
                AppGroup.DECL_DETAIL_READ,
                AppGroup.DECL_HISTORY_READ,
        ...
        _view(
            ...
            [
                ...
                AppGroup.RESOURCE_LIBRARY_READ,
                AppGroup.MATHLIB_INDEX_READ,
                AppGroup.DECL_STAGE_REVIEW_MARK_WRITE,
            ],
