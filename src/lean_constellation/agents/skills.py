    ...
    SkillKey.PDF_FAITHFUL_TRANSCRIPTION.value: LeanSkillDefinition(
        ...
        body=_body(
            ...
            (
                ...
                "When choosing a representation for mathematical PDF content, LaTeX is the default durable representation. Preserve a coherent authored format when one exists; otherwise use a sectioned LaTeX tree for a complete paper, multiple top-level sections, or long theorem/proof clusters, and reserve a single file for genuinely brief material with no natural subdivision.",
    ...
    SkillKey.MATERIAL_FIDELITY_CHECK.value: LeanSkillDefinition(
        ...
        body=_body(
            ...
            (
                ...
                "For multi-file material, follow the canonical entry and reading order, check cross-file joins for omission or duplication, and verify that numbering, bibliography, citations, and cross-references still identify the same source objects.",
    ...
    SkillKey.SOURCE_CORPUS_DRAFT_CURATION.value: LeanSkillDefinition(
        ...
        body=_body(
            ...
            (
                ...
                "For PDF-only input, create a complete corrected textual transcription rather than a summary. Represent a complete paper or other non-brief multi-section mathematical work as a LaTeX entry plus files split at natural source sections or theorem/proof clusters; use a single durable content file only for brief material with no natural subdivision.",
    ...
    SkillKey.RESOURCE_DRAFT_CURATION.value: LeanSkillDefinition(
        ...
        body=_body(
            ...
            (
                ...
                "Preserve a coherent authored tree or authored single-file format. For a complete or long multi-section mathematical Resource reconstructed from PDF, use a LaTeX canonical entry and files split at natural sections or theorem/proof clusters; a short focused excerpt, single theorem, or brief prose-heavy item may remain one `.tex` or Markdown file.",
