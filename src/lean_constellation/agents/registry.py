...
def validate_agent_resources(
    ...
    *,
    ...
    application_tools: Sequence[object] | None = None,
    ...
    app_tools = list(application_tools) if application_tools is not None else build_application_tool_specs()
    app_groups = list(application_groups) if application_groups is not None else build_application_tool_groups(app_tools)
...
AGENT_TYPE_SPECS: tuple[AgentTypeSpec, ...] = (
    _spec(
        agent_type=ProductionAgentTypeKey.RESTRUCTURE_COORDINATOR,
        role="coordinator",
        lifecycle_group="restructure",
        context_scope="repo",
        agent_step_type="restructure_repo_plan_agent_step",
        fragments=[
            *COMMON_FRAGMENTS,
        ...
        skills=[SkillKey.RESTRUCTURE_REPO_PLANNING],
        app_view=AppView.RESTRUCTURE_COORDINATOR,
        submit_view=SubmitView.RESTRUCTURE_COORDINATOR_SUBMIT,
        aliases=["restructure_coordinator", "RestructureCoordinator"],
    ),
    _spec(
        agent_type=ProductionAgentTypeKey.RESTRUCTURE_CONTENT_PLAN,
        role="plan",
        lifecycle_group="restructure",
        context_scope="content_node",
        agent_step_type="restructure_content_agent_step",
        fragments=[
            *BLOCKED_FRAGMENTS,
            "repo.native_repo_context",
            "source.source_corpus_context",
        ...
        skills=[SkillKey.RESTRUCTURE_DECL_CAPTURE],
        app_view=AppView.RESTRUCTURE_CONTENT,
        submit_view=SubmitView.RESTRUCTURE_CONTENT_SUBMIT,
        aliases=["restructure_content_plan", "RestructureContentPlan"],
        stage="declared",
    ),
    _spec(
        agent_type=ProductionAgentTypeKey.RESTRUCTURE_CONTENT_IMPLEMENTATION,
        role="worker",
        lifecycle_group="restructure",
        context_scope="content_node",
        agent_step_type="restructure_content_agent_step",
        ...
        skills=[SkillKey.RESTRUCTURE_PROOF_COMPLETION],
        app_view=AppView.RESTRUCTURE_CONTENT,
        submit_view=SubmitView.RESTRUCTURE_CONTENT_SUBMIT,
        aliases=["restructure_content_implementation", "RestructureContentImplementation"],
        stage="proved",
    ),
    _spec(
        agent_type=ProductionAgentTypeKey.RESTRUCTURE_CONTENT_REVIEW,
        role="reviewer",
        lifecycle_group="restructure",
        context_scope="content_node",
        agent_step_type="restructure_review_agent_step",
        fragments=[
            *REVIEWER_FRAGMENTS,
            "node.scope_content_node_context",
            "content.content_contract_task_context",
        ...
        skills=[],
        app_view=AppView.RESTRUCTURE_REVIEW,
        submit_view=SubmitView.RESTRUCTURE_REVIEW_SUBMIT,
        aliases=["restructure_content_review", "RestructureContentReview"],
    ),
    _spec(
    ...
    _spec(
        agent_type=ProductionAgentTypeKey.SOURCE_CORPUS_BUILDER,
        role="worker",
        lifecycle_group="repo_lifecycle",
        context_scope="repo",
        agent_step_type="source_corpus_builder_agent_step",
        ...
        aliases=["SourceCorpusBuilder", "source_corpus_builder"],
    ),
    _spec(
        agent_type=ProductionAgentTypeKey.SOURCE_CORPUS_REVIEWER,
        role="reviewer",
        lifecycle_group="repo_lifecycle",
        context_scope="repo",
        agent_step_type="source_corpus_reviewer_agent_step",
        fragments=[
            *REVIEWER_FRAGMENTS,
            "repo.native_repo_context",
            "source.source_corpus_context",
        ...
        aliases=["SourceCorpusReviewer", "source_corpus_reviewer"],
    ),
    _spec(
        ...
        skills=[SkillKey.SOURCE_EVIDENCE_REFERENCING],
    ...
    _spec(
        agent_type=ProductionAgentTypeKey.REPO_RESOURCE_DISCOVERY,
        role="worker",
        lifecycle_group="coordinator",
        context_scope="repo",
        agent_step_type="repo_resource_discovery_agent_step",
        fragments=[
            *COMMON_FRAGMENTS,
            "workspace.repo_workspace_context",
            "source.source_corpus_context",
    ...
    _spec(
        agent_type=ProductionAgentTypeKey.REPO_LEAN_PROVIDER_DISCOVERY,
        role="worker",
        lifecycle_group="coordinator",
        context_scope="repo",
        agent_step_type="repo_lean_provider_discovery_agent_step",
        fragments=[
            *COMMON_FRAGMENTS,
            "workspace.repo_workspace_context",
            "workspace.requirement_and_lake_dependency_context",
        ...
        skills=[SkillKey.REPO_LEAN_PROVIDER_DISCOVERY],
        app_view=AppView.REPO_LEAN_PROVIDER_DISCOVERY,
        submit_view=SubmitView.REPO_LEAN_PROVIDER_DISCOVERY_SUBMIT,
        aliases=["RepoLeanProviderDiscovery", "repo_lean_provider_discovery"],
    ),
    _spec(
        agent_type=ProductionAgentTypeKey.REPO_MATHLIB_RECON,
        role="worker",
        lifecycle_group="coordinator",
        context_scope="repo",
        agent_step_type="repo_mathlib_recon_agent_step",
        fragments=[
            *COMMON_FRAGMENTS,
            "workspace.repo_workspace_context",
            "source.source_corpus_context",
        ...
        skills=[
            SkillKey.REPO_MATHLIB_RECON,
            SkillKey.MATHLIB_INDEX_FIRST_RECON,
            SkillKey.MATHLIB_SEMANTIC_SEARCH_NAVIGATION,
            SkillKey.MATHLIB_INDEX_ENTRY_CURATION,
        ],
        app_view=AppView.REPO_MATHLIB_RECON,
        submit_view=SubmitView.REPO_MATHLIB_RECON_SUBMIT,
        aliases=["RepoMathlibRecon", "repo_mathlib_recon"],
    ),
    _spec(
        ...
        skills=[
            ...
            SkillKey.COORDINATOR_BLOCKED_CONSUMER_REPLAN,
    ...
    _spec(
        ...
        skills=[
            ...
            SkillKey.CONTENT_PLAN_COMPLETION_POLICY,
