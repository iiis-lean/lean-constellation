...
class SkillKey(StrEnum):
    ...
    PDF_FAITHFUL_TRANSCRIPTION = "pdf-faithful-transcription"
    MATERIAL_FIDELITY_CHECK = "material-fidelity-check"
    SOURCE_CORPUS_DRAFT_CURATION = "source-corpus-draft-curation"
