...
class SkillKey(StrEnum):
    ...
    COORDINATOR_PROVED_FULL_GRAPH_MODE = "coordinator-proved-full-graph-mode"
    COORDINATOR_DECLARED_FULL_GRAPH_MODE = "coordinator-declared-full-graph-mode"
    COORDINATOR_DECLARED_INTERFACE_MODE = "coordinator-declared-interface-mode"
    ...
    CONTENT_PLAN_PROVED_FULL_GRAPH_MODE = "content-plan-proved-full-graph-mode"
    CONTENT_PLAN_DECLARED_FULL_GRAPH_MODE = "content-plan-declared-full-graph-mode"
    CONTENT_PLAN_DECLARED_INTERFACE_MODE = "content-plan-declared-interface-mode"
