...
def test_decl_stage_groups_expose_expected_tools() -> None:
    ...
    assert_group_contains("decl_stage_statement_formal_file", {"prepare_statement_formal_file", "capture_statement_formal_file"})
    assert_group_contains("decl_stage_proof_formal_file", {"prepare_proof_formal_file", "capture_proof_formal_file"})
