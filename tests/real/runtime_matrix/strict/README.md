...
- 默认 strict suite 当前 registry surface 为 252 个 application tools，其中 202 个 ToolCase 标记 implemented，38 个 pending fixture，12 个 env-gated；implemented 部分审 Flow / LogicStep / AgentStep / submit / checkpointed write evidence。
