...
def _run_adapter_tool_sweep(ws: RuntimeMatrixWorkspace, server: Any, recorder: EvidenceRecorder) -> None:
    ...
    statement_nl = call_tool_with_evidence(
        ...
        "set_adapter_statement_nl",
        {
            ...
            "detail": "Runtime Matrix adapter ToolSweep.",
        },
        runtime_context=adapter_ctx,
        recorder=recorder,
    ...
    proof_nl = call_tool_with_evidence(
        ...
        {"name": "main_result", "summary": "The theorem follows by triviality.", "detail": None},
        runtime_context=adapter_ctx,
        recorder=recorder,
...
def _create_complete_adapter_decl(
    ...
    *,
    ...
    created = call_tool_with_evidence(
        ...
        "adapter_repo_import",
        "create_adapter_decl",
        {"name": name, "kind": "theorem", "module": "Upstream", "plan_summary": summary},
        runtime_context=adapter_ctx,
        recorder=recorder,
    ...
    assert call_tool_with_evidence(
        ...
        "adapter_repo_import",
        "set_adapter_statement_formal",
        {"name": name, "code": statement, "upstream_decl_name": name},
        runtime_context=adapter_ctx,
        recorder=recorder,
    ...
    assert call_tool_with_evidence(
        ...
        "adapter_repo_import",
        "set_adapter_statement_nl",
        {"name": name, "summary": f"Statement for {name}.", "detail": None},
        runtime_context=adapter_ctx,
        recorder=recorder,
    ...
    assert call_tool_with_evidence(
        ...
        "adapter_repo_import",
        "set_adapter_proof_nl",
        {"name": name, "summary": f"Proof for {name}.", "detail": None},
        runtime_context=adapter_ctx,
        recorder=recorder,
